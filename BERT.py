...
parser.add_argument(
    "--model", type=str, default="tabularisai/multilingual-sentiment-analysis"
)
parser.add_argument(
...
if __name__ == "__main__":
    ...
    train_set = Dataset(json_file=args.train_file)

    valid_set = Dataset(json_file=args.valid_file)
    ...
    test_loader = DataLoader(
        test_set, batch_size=8, shuffle=False, collate_fn=collator
    )
