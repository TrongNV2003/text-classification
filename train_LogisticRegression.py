...
from training.trainer import LogisticRegression_Trainer
...
if __name__ == "__main__":
    ...
    train_text_vect = lr.vectorize_train(train_text)
    test_text_vect = lr.vectorize_test(test_text)
    ...
    f1(test_text_vect)
    result_recorder("result/output_lr.json")
