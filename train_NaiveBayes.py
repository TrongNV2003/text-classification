...
from training.trainer import NB_Trainer
...
if __name__ == "__main__":
    ...
    train_text_vect = nb.vectorize_train(train_text)
    test_text_vect = nb.vectorize_test(test_text)
    ...
    f1(test_text_vect)
    result_recorder("result/output_nb.json")
